...
;
;
Superview.Rect=function(){Rect=function(a){extend(this).withObject(a)},Rect.prototype={has:function(a){return this["has"+a.variableize(!0)]()},flatten:function(){var a=this,b={};["top","left","bottom","right","width","height"].forEach(function(c){typeof a[c]!="undefined"&&(b[c]=a[c])});return b}},["Top","Right","Bottom","Left"].forEach(function(a){Rect.prototype["has"+a]=function(){var b=this[a.toLowerCase()];return typeof b=="number"&&b!==NaN&&b!==Infinity}}),["Width","Height"].forEach(function(a){Rect.prototype["has"+a]=function(){var b=this[a.toLowerCase()];return typeof b=="number"&&b!==NaN&&b!==Infinity&&b>=0}});return Rect}()
;
;
Superview.Restrictions=function(){Restrictions=function(a){extend(this).withObject(a),this.minimum=new Superview.Rect(a.minimum),this.maximum=new Superview.Rect(a.maximum)},Restrictions.prototype={flatten:function(){var a={};a.minimum=this.minimum.flatten(),a.maximum=this.maximum.flatten();return a}},["Minimum","Maximum"].forEach(function(a){Restrictions.prototype["has"+a]=function(){return typeof this[a.toLowerCase()]=="object"}});return Restrictions}()
;
;
